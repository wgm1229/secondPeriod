<template>
  <div>
    <van-nav-bar title="歌手分类" left-text="返回" left-arrow>
      <template #right>
    ...
    <div class="singers">
      <div class="singers-content">
        <ol>
          ...
          @click="handleDetail(item.singer_name,item.singer_mid)">
            <img :src="item.singer_pic" alt />
...
export default {
  ...
  methods: {
    ...
    handleDetail(singer_name,singer_mid){
      // console.log('123')
      this.$router.push({
        name:'detail',
        params:{
